  ...
  return (
    <div className="px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(./assets/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen">
        <div className="text-center mb-6">
            <h1 className="text-3xl sm:text-5xl mdr:text-6xl 2xl:text-7xl font-semibold mx-auto leading-[1.2]">Create amazing content <br/> <span className='text-primary'>with AI Tools</span></h1>
